<%-- 
    Document   : Finance
    Created on : 30.05.2015, 10:15:39
    Author     : user
--%>
...
<table border="2" width="400">
    <tr>
        <td width="70%">Общие затраты на сегодняшний день составили:</td>
        <td width="30%">${totalSum}</td>
    </tr>
    <tr>
        <td width="70%">В том числе затраты на закупку материалов:</td>
        <td width="30%">${deliveryCost}</td>
    </tr>
    <tr>
        <td width="70%">И затраты на хранение материалов:</td>
        <td width="30%">${storageCost}</td>
    </tr>
</table>                  
                </td>
