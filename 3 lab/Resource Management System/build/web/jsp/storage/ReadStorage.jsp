<%-- 
    Document   : ReadOrder
    Created on : 17.05.2015, 10:51:49
    Author     : user
--%>
...
<table border="3" width="100%">
    <tr>
        <td align="center" colspan="6">Склад</td>
    </tr>
            <tr>
                <td align="center"><b>№</b></td>
                <td align="center"><b>Название материала</b></td>
                <td align="center"><b>Спецификация материала</b></td>
                <td align="center"><b>Дата поступления на склад</b></td>
                <td align="center"><b>Число единиц</b></td>
                <td align="center"><b>Объем</b></td>
            </tr>
            <c:forEach var="storage" items="${List}">
                <tr>
                    <td align="center" width="5%">${storage.id}</td>
                    <td align="center" width="20%">${storage.material.title}</td>
                    <td align="center" width="20%">${storage.material.specification}</td>
                    <td align="center" width="20%">${storage.receiptDate}</td>
                    <td align="center" width="15%">${storage.numberOfMaterialUnits}</td>
                    <td align="center" width="20%">${storage.totalVolumeOfMaterial}</td>
                </tr>
            </c:forEach>
        </table>            
                </td>
