...
<table width="100%" border="3">
        ...
        <table border="3" width="100%">
         ...
         <form method="POST" action="Servlet">
             <input type="hidden" name="dateForvarded" value="${date}"/>
            <input type="hidden" name="command" value="UpdateSupplier"/>
            <table border="3">
                <tr>
                    <td>
                        Введите № поставщика для редактирования:
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        Введите № материала поставки:
                    </td>
                    <td>
                        <input type="number" name="id_mat"/>
                    </td>
                </tr>
                <tr>
                    <td>
